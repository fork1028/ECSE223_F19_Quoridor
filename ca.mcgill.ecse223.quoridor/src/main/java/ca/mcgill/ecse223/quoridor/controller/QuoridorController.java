...
public class QuoridorController {
	...
	public static boolean loadGamePlaceWall(String move) throws InvalidInputException {
		...
		if (validPlace) {
			...
			GamePosition newGamePos = (isBlackTurn())
					? new GamePosition(curGame.numberOfPositions() + 1, opponentPos, newPos, curGame.getWhitePlayer(),
							curGame)
					: new GamePosition(curGame.numberOfPositions() + 1, newPos, opponentPos, curGame.getBlackPlayer(),
							curGame);
