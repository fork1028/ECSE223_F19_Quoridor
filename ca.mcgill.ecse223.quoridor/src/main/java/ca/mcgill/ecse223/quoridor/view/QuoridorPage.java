...
public class QuoridorPage extends JFrame{
	...
	//TODO: link QuoridorStartGame and QuoridorGamePage to this page
	//flow should be that after quoridor start game is set, quoridor game page is shown and players can start playing
//
